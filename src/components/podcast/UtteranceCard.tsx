...
export default function UtteranceCard({ 
  ...
  const getSpeakerColorClass = () => {
    ...
    } else if (item.speaker.includes("MC3")) {
      return {
        bg: 'bg-green-50 dark:bg-green-900/30',
        border: 'border-green-200 dark:border-green-800',
        icon: 'bg-green-100 text-green-600 dark:bg-green-800 dark:text-green-300',
        text: 'text-green-700 dark:text-green-300',
        audioBtn: 'bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-600',
        lightBg: 'bg-green-50 dark:bg-green-900/20',
        lightBorder: 'border-green-100 dark:border-green-900'
      };
    }else {
      return {
